...
export const api = {
  ...
  depsGraph: (name: string, isCask: boolean) => App.DepsGraph(name, isCask),
  exportDependencyGraphPNG: (name: string, pngDataURL: string) => App.ExportDependencyGraphPNG(name, pngDataURL),
